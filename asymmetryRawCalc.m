function asymmetryRawCalc(app)
    ...
    currentStatus = uiprogressdlg(app.UIFigure,'Message','Calculating raw XA and asymmetry images');
    for i = 1:numImages
    ...
    app.imgRawXA = (imgRCP + imgLCP) / 2;

    switch convention
        case '(RCP-LCP)/Sum'
            app.imgRawXMCD = (imgRCP - imgLCP)./(imgRCP + imgLCP);
        case '(LCP-RCP)/Sum'
            app.imgRawXMCD = (imgLCP - imgRCP)./(imgRCP + imgLCP);
    end
    ...
    app.view_imageType.Value = "Raw asymmetry";
